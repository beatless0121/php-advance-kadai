             ...
             <table class="books-table">
                 ...
                 foreach ($books as $books) {
                     $table_row = "
                         ...
                         <td>{$books['price']}</td>
                         <td>{$books['stock_quantity']}</td>
                         <td>{$books['genre_code']}</td>  
                         <td><a href='update.php?id={$books['id']}'><img src='images/edit.png' alt='編集' class='edit-icon'></a></td>
                         <td><a href='delete.php?id={$books['id']}'><img src='images/delete.png' alt='削除' class='delete-icon'></a></td>       
                         </tr>                    
                     ";
                     echo $table_row;
                 }
